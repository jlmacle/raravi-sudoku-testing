Feature: 3 levels of difficulty : Easy, Medium and Hard
    ...
    Scenario: US 2.1-a: Levels : When the application starts, the level is set on "Easy"
        When "Chrome" is on the homepage
        Then The default level is easy ["Chrome"]

    # Scenario: US 2.1-b: Levels : When the application starts, the level is set on "Easy"
    #     When "Chromium" is on the homepage
    #     Then The default level is easy ["Chromium"]
